...
wacs.exe --source manual --host suttasearch.net --validation selfhosting --store pemfiles --pemfilespath "%CERTS_DIR%" --installation none --accepttos --emailaddress admin@suttasearch.net
cd ..
