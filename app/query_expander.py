...
def merge_expansion(local: dict, ai: dict | None) -> dict:
    ...
    for key in [
        ...
        if key in {"paliHints", "mustHavePali", "shouldHavePali", "avoidPali", "expandedQueries"}:
...
def expand_query_with_ai(query: str) -> dict | None:
    ...
    prompt = "\n".join(
        [
            ...
            '{"mainMeaning":"","vietnameseKeywords":[],"relatedConcepts":[],"paliHints":[],"mustHavePali":[],"shouldHavePali":[],"avoidPali":[],"expandedQueries":[]}',
    ...
    for model in _models():
        try:
            ...
            for key in ["paliHints", "mustHavePali", "shouldHavePali", "avoidPali", "expandedQueries"]:
