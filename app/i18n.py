...
STRINGS: dict[str, dict[str, str]] = {
    "vi": {
        ...
        "summary.title": "✨ Tóm tắt bài kinh (AI)",
        "summary.loading": "Đang phân tích và tóm tắt...",
        "summary.empty": "Không thể tạo tóm tắt.",
        "summary.error": "Lỗi tải tóm tắt.",
        "summary.readPassage": "Bạn có muốn đọc đoạn kinh này không?",
    ...
    "en": {
        ...
        "summary.loading": "Analyzing and summarizing...",
        "summary.empty": "Failed to generate summary.",
        "summary.error": "Error loading summary.",
        "summary.readPassage": "Do you want to read this passage?",
    ...
    "my": {
        ...
        "summary.title": "✨ AI အကျဉ်းချုပ်",
        "summary.loading": "ခွဲခြမ်းစိတ်ဖြာ၍ အကျဉ်းချုံးနေသည်...",
        "summary.empty": "အကျဉ်းချုပ် ဖန်တီး၍ မရပါ။",
        "summary.error": "အကျဉ်းချုပ် တင်ရာတွင် အမှားအယွင်းရှိသည်။",
        "summary.readPassage": "ဤကျမ်းပိုဒ်ကို ဖတ်လိုပါသလား။",
        ...
        "feedback.label": "အကြံပြုချက် ရေးသားရန်",
        "feedback.placeholder": "",
        "feedback.maxChars": "{count} အက္ခရာ အများဆုံး ရေးနိုင်သည် - {remaining} ကျန်သေးသည်",
