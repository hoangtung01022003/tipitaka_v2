...
STRINGS: dict[str, dict[str, str]] = {
    "vi": {
        ...
        "results.fallbackTitle": "Kết quả tìm kiếm mở rộng",
        "results.fallbackBody": "Hệ thống đã tự động điều chỉnh từ khóa thành «{query}» để trả về các kết quả phù hợp nhất dưới đây.",
        ...
        "match.humanTranslation": "Khớp trực tiếp trong bản dịch đã căn chỉnh với đoạn Pāli này.",
        "match.humanTranslationSection": "Khớp trực tiếp trong chương song ngữ đã căn chỉnh với phần Pāli này.",
        ...
        "help.readWholeSutta": "Đọc toàn bộ bài kinh",
        "manualSutta.backGuide": "← Về trang hướng dẫn",
        "manualSutta.defaultTitle": "Toàn bộ bài kinh",
        "manualSutta.paliTitle": "Nguyên bản Pali",
        "manualSutta.paliHint": "Toàn bộ nội dung Pali do ban quản trị cung cấp.",
        "manualSutta.translateTitle": "Bản dịch AI",
        "manualSutta.translateHint": "Bản dịch được tạo theo từng phần và ghép theo đúng thứ tự.",
        "manualSutta.translateButton": "Bắt đầu dịch bài kinh bằng AI",
        "manualSutta.translatingPart": "Đang dịch phần {part}/{total}...",
        "manualSutta.translateDone": "Đã dịch toàn bộ bài kinh.",
        "manualSutta.translateError": "Chưa dịch được phần này. Vui lòng thử lại.",
    ...
    "en": {
        ...
        "results.fallbackTitle": "Expanded Search Results",
        "results.fallbackBody": "The system automatically adjusted your keywords to «{query}» to return the most relevant results below.",
        ...
        "match.humanTranslation": "Direct match in a human translation aligned to this Pali passage.",
        "match.humanTranslationSection": "Direct match in a bilingual section aligned to this Pali range.",
        ...
        "help.readWholeSutta": "Read the whole discourse",
        "manualSutta.backGuide": "← Back to the guide",
        "manualSutta.defaultTitle": "Complete discourse",
        "manualSutta.paliTitle": "Original Pali",
        "manualSutta.paliHint": "The complete Pali text provided by the administrators.",
        "manualSutta.translateTitle": "AI translation",
        "manualSutta.translateHint": "The translation is generated in parts and assembled in order.",
        "manualSutta.translateButton": "Start translating the discourse with AI",
        "manualSutta.translatingPart": "Translating part {part}/{total}...",
        "manualSutta.translateDone": "The complete discourse has been translated.",
        "manualSutta.translateError": "This part could not be translated. Please try again.",
    ...
    "my": {
        ...
        "results.fallbackTitle": "တိုးချဲ့ရှာဖွေမှု ရလဒ်များ",
        "results.fallbackBody": "စနစ်က သော့ချက်စာလုံးကို «{query}» သို့ အလိုအလျောက် ပြုပြင်၍ အသင့်တော်ဆုံး ရလဒ်များကို အောက်တွင် ပြသထားပါသည်။",
        ...
        "match.humanTranslation": "ဤပါဠိစာပိုဒ်နှင့် ချိတ်ဆက်ထားသော လူဘာသာပြန်စာတွင် တိုက်ရိုက်ကိုက်ညီသည်။",
        "match.humanTranslationSection": "ဤပါဠိအပိုင်းနှင့် ချိတ်ဆက်ထားသော ဘာသာနှစ်မျိုးကဏ္ဍတွင် တိုက်ရိုက်ကိုက်ညီသည်။",
        ...
        "help.readWholeSutta": "သုတ္တန်အပြည့်အစုံ ဖတ်ရန်",
        "manualSutta.backGuide": "← လမ်းညွှန်သို့ ပြန်သွားရန်",
        "manualSutta.defaultTitle": "သုတ္တန်အပြည့်အစုံ",
        "manualSutta.paliTitle": "မူရင်းပါဠိ",
        "manualSutta.paliHint": "စီမံခန့်ခွဲသူများ ထည့်သွင်းထားသော ပါဠိစာသားအပြည့်အစုံ။",
        "manualSutta.translateTitle": "AI ဘာသာပြန်",
        "manualSutta.translateHint": "ဘာသာပြန်ကို အပိုင်းလိုက် ဖန်တီးပြီး အစဉ်လိုက် ပေါင်းစည်းထားသည်။",
        "manualSutta.translateButton": "သုတ္တန်ကို AI ဖြင့် စတင်ဘာသာပြန်ရန်",
        "manualSutta.translatingPart": "အပိုင်း {part}/{total} ကို ဘာသာပြန်နေသည်...",
        "manualSutta.translateDone": "သုတ္တန်တစ်ခုလုံးကို ဘာသာပြန်ပြီးပါပြီ။",
        "manualSutta.translateError": "ဤအပိုင်းကို ဘာသာမပြန်နိုင်ပါ။ ထပ်စမ်းပါ။",
